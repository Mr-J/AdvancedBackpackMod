...
public class InventoryBackpackMagic extends InventoryBackpackGeneral {
	...
	public int readInvSizeFromOwnerNBT(EntityPlayer entityPlayer, int color)
	{
		...
		{
			NBTTagCompound abmInventoryMagic = (NBTTagCompound) playerPersisted.getTag("abmInventoryMagic");
    ...
    public void writeToNBT(NBTTagCompound myCompound)
    {
		...
		if (playerPersisted == null)
		{
			playerPersisted = new NBTTagCompound();
		}
		...
		playerPersisted.setTag("abmInventoryMagic", abmInventoryMagic);
